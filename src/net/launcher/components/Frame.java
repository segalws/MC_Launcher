...
public class Frame extends JFrame implements ActionListener, FocusListener
{
	...
	public static Button toPersonal = new Button("Скин");
	...
	public Button toGamePersonal = new Button("Назад");
...
/*
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() == login || e.getSource() == password || e.getSource() == toGame || e.getSource() == toAuth || e.getSource() == toPersonal)
		{
