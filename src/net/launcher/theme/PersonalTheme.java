...
public class PersonalTheme
{
	...
	public static ButtonStyle	 buyCloak	  = new ButtonStyle(180, 230, 180, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
	public static ButtonStyle	 changeskin	  = new ButtonStyle(180, 280, 180, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
	public static ButtonStyle	 buyVip		  = new ButtonStyle(20, 370, 140, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
	public static ButtonStyle	 buyPremium	  = new ButtonStyle(20, 410, 140, 40, "font", "button", 14F, Color.WHITE, true, Align.CENTER);
	public static ButtonStyle	 buyUnban	  = new ButtonStyle(20, 450, 140, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
	...
	public static ButtonStyle	 vaucherButton= new ButtonStyle(550, 180, 130, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
	public static ButtonStyle	 buyVaucher	  = new ButtonStyle(400, 180, 140, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
	...
	public static ButtonStyle	 toGamePSL    = new ButtonStyle(746, 448, 88, 40, "font", "button", 16F, Color.WHITE, true, Align.CENTER);
}